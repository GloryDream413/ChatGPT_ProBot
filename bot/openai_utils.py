...
class ChatGPT:
        ...
        while answer is None:
            try:
                if self.use_chatgpt_api:
                    ...
                    n_used_tokens = self._count_tokens_for_chatgpt(messages, answer, model="gpt-4-0314")
                else:
                    prompt = self._generate_prompt(message, dialog_messages, chat_mode)
    ...
    def _count_tokens_for_chatgpt(self, prompt_messages, answer, model="gpt-4-0314"):
